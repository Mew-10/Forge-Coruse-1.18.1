...
public class BlacklosTableScreen extends AbstractContainerScreen<BlacklosTableMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(MCCourseMod.MOD_ID, "textures/gui/blacklos_table_gui.png");

    public BlacklosTableScreen(BlacklosTableMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
