...
public class BlacklosTableRecipe implements Recipe<SimpleContainer> {
    private final ResourceLocation id;
    private final ItemStack output;
    private final NonNullList<Ingredient> recipeItems;

    public BlacklosTableRecipe(ResourceLocation id, ItemStack output,
    ...
    public static class Type implements RecipeType<BlacklosTableRecipe> {
        private Type() { }
        public static final Type INSTANCE = new Type();
        public static final String ID = "blacklos_crafting";
    }
    ...
    public static class Serializer implements RecipeSerializer<BlacklosTableRecipe> {
        ...
        public BlacklosTableRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new BlacklosTableRecipe(id, output, inputs);
        }

        @Override
        public BlacklosTableRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, BlacklosTableRecipe recipe) {
