package net.benjamin.mccourse.world.dimension;
...
public class ModDimensions {
    public static final ResourceKey<Level> KJDIM_KEY = ResourceKey.create(Registry.DIMENSION_REGISTRY,
            new ResourceLocation(MCCourseMod.MOD_ID, "kjdim"));
    ...
    public static void register() {
        System.out.println("Registering ModDimensions for " + MCCourseMod.MOD_ID);
    }
}